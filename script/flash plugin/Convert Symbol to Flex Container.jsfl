...
function createFlexContentSymbol() {
	...
	var fileURI = fl.configURI + "Flex/ContentHolder.fla";
	var copiedSymbol = fl.copyLibraryItem(fileURI, "FlexContentHolder");
	if (copiedSymbol) {
		doc.clipPaste();
		doc.deleteSelection();
...
if (fl.runScript(fl.configURI + 'Javascript/MakeFlexComponent.jsfl', 'makeFlexComponent', 'mx.flash.ContainerMovieClip', 1))
